# Lost Trail Lodge — lost-trail-lodge.com

Static website for **lost-trail-lodge.com**. There is **no build step** — every file in this
repo is the site exactly as it deploys. Open `index.html` locally and it works.

Pages: `index.html` (Lost Trail), `lost-trail-area-guide.html`, `guide-lost-trail.html` (off-grid guest guide — noindex, QR target), `terms.html`, `privacy.html`.
...
3. **Domain management** → add custom domain **lost-trail-lodge.com**; let Netlify handle SSL.
